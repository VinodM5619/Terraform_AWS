...
resource "aws_vpc" "secondary" {
  ...
  tags = {
    Name = "secondary_vpc_${var.secondary}"
  }
}
...
resource "aws_subnet" "primary_subnet" {
  ...
  tags = {
    Name = "primary_subnet_${var.primary}"
    Environment = "Demo"
  }
}
...
resource "aws_subnet" "secondary_subnet" {
  ...
  map_public_ip_on_launch = true
  tags = {
    Name = "secondary_subnet_${var.secondary}"
    Environment = "Demo"
  }
}
...
resource "aws_internet_gateway" "secondary_igw" {
  ...
  tags = {
    Name = "secondary_igw_${var.secondary}"
    Environment = "Demo"
  }
}
...
resource "aws_vpc_peering_connection" "primary_to_secondary" {
  ...
  tags = {
    Name = "vpc_peering_${var.primary}_to_${var.secondary}"
    Environment = "Demo"
  }
}
...
resource "aws_vpc_peering_connection_accepter" "peering_accepter" {
  ...
  tags = {
    Name = "vpc_peering_accepter_${var.secondary}_to_${var.primary}"
  }
}
...
resource "aws_route" "primary_to_secondary" {
  ...
  depends_on = [aws_vpc_peering_connection_accepter.peering_accepter]
}
