...
resource "aws_elastic_beanstalk_environment" "green" {
  ...
  application         = aws_elastic_beanstalk_application.app.name
  solution_stack_name = null #var.solution_stack_name
  tier                = "WebServer"
  version_label       = aws_elastic_beanstalk_application_version.v2.name
  platform_arn = "arn:aws:elasticbeanstalk:us-east-1::platform/Node.js 20 running on 64bit Amazon Linux 2023/6.7.1"
